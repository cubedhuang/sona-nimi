...
{#if word}
	<div
		class="fixed bottom-4 right-4 w-[36rem] max-h-[48rem] p-6 overflow-y-auto bg-white border border-gray-400 rounded-lg shadow-lg"
		transition:fly={{ x: 48, duration: 300 }}
	>
		<div class="flex">
